...
def train(data,preference=-60,damping=0.9,max_iter=500,conbergence_iter =15):
    '''
    :param data: 一行为一个样本
    :param preference: 每一个数据点的参考度
    :param damping: 阻尼系数，用户控制数据的收敛速度
    :param max_iter:
    :param conbergence_iter: 比较多少次聚类中心不变之后停止迭代
    :return:
    '''
    exemplars, similarity = MYAffinityPropagation(data, preference=preference, damping=damping, max_iter=max_iter, convergence_iter=conbergence_iter)
